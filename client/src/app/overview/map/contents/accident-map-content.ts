...
import * as mockData from "./mock-accidents-data";
...
export class AccidentMapContent implements MapContent {
  ...
  private getMapContentAndDraw(): void {
    ...
    // waiting for a real server communication we will continue to use mock data
    // TODO: Use data from server again
    ...
    this.draw(mockData.MOCKACCIDENTDATA);
  }
